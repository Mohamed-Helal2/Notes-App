        ...
        builder: (context, state) {
          return Stack(
            ...
            children: [
              GridView.builder(
                itemCount:
                    context.read<AddNoteCubit1>().selectedImagePaths0.length,
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        context.read<AddNoteCubit1>().getImage(
                              ImageSource.camera,
                            );
                      },
                      child:
                    ...
                    ElevatedButton(
                        onPressed: () {
                          context.read<AddNoteCubit1>().getmultiimage();
                        },
                        child: Custom_Text(
                            text: "Gallery",
                            fontsize: 14,
